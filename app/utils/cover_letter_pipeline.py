...
Rules:
- structure_ok=true only if the letter has a subject/objet line, a salutation, and a closing formula.
...
- Keep coherent letter structure with a subject/objet line, a salutation, a body, and a closing formula.
